    ...
    */
    ...
    public function detail(){
        ...
        if( $order['mobile'] == "42368" ){
            ...
            $tempUserInfo = findDataWithCondition("users",array('user_id'=>$order['user_id']));
            $order['mobile']  = $arr[$order['user_id']%34].mb_strcut($tempUserInfo["reg_time"],2);
        }
