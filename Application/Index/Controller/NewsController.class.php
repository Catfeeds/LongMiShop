...
exit;
        $sql = "SELECT o.address ,o.province ,o.city ,o.district, u.nickname,o.mobile
FROM  `lm_order` o,  `lm_users` u
WHERE  u.user_id = o.user_id
AND add_time >= 1483200000
...
//        dd(count($data));
        ...
        foreach($data as $k=>$val){
            ...
            $strTable .= '<td style="text-align:center;font-size:12px;" width="100">'.$val['nickname'].'</td>';
