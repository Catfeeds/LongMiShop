<?php
@include 'Addons/turntable/Function/base.php';


class turntableMobileController
{
    ...
    public function __construct($userInfo)
    {
        ...
        $this->user = $userInfo;
        $this->config = turntableGetConfig();
        $this->edition = $this->config["edition"];
        $this->assignData["configs"] = turntableGetConfig();
        $this->assignData["__theme"] = $this->config["data"][$this->edition]['theme'];
        $this->assignData["__temp"] = "/Addons/turntable/Template/Mobile/" . $this->assignData["__theme"] . "/Static";
    ...
    public function index()
    {
        ...
        $this->assignData["config"] = array(
            ...
            "share_img" => "http://" . $_SERVER["HTTP_HOST"] . "/Addons/turntable/logo.jpg",
            "share_url" => "http://" . $_SERVER["HTTP_HOST"] . U('Mobile/Addons/turntable')
        );
        $weChatLogic = new \Common\Logic\WeChatLogic();
        $this->assignData["signPackage"] = $weChatLogic->getSignPackage();

        $data = turntableGetData($this->user["user_id"], $this->edition, I("activityId", null));
    ...
    {
        $res = turntableCreateActivity($this->user["user_id"], $this->edition);
    ...
    public function help()
    {
        ...
        $res = turntableHelpAction($activityId, $this->user["user_id"], $this->edition);
        exit(json_encode($res));
    }
    ...
    {
        $res = turntableSetData($this->user["user_id"], $this->edition, $_GET);
        exit(json_encode($res));
    }
