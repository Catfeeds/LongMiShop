...
$(".up").addClass("up"); 
$(".up").click(function(){ 
$(".float_nav ul").slideToggle() 
$(this).toggleClass("down") 
}); 
	$('.intelligence').find('.list').find('li').each(function(i){
		$(this).click(function(){
			$('.intelligence').find('.list').find('li').removeClass('nav_current');
			$(this).addClass('nav_current');
			$('body,html').animate({scrollTop: $('.intelligence').find('.h1').eq(i).offset().top}, 0);
			})
		})
	var dayBarNow=0;	
	if($('.float_nav').length>0){
		$(window).scroll(function(){
			$('.intelligence').find('.h1').each(function(i){
				if($(window).scrollTop()>=$(this).offset().top){
					$('.float_nav').find('.list').find('li').removeClass('nav_current');
					$('.float_nav').find('.list').find('li').eq(i).addClass('nav_current');
					}
				})		
			})
		}
