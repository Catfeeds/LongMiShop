!
	function(e) {
		...
		window.jQuery = n(30), window.$ = window.jQuery, window.doT = n(31), window.multiline = n(32), n(33), n(34), n(35), n(36), $.cookie = n(37), n(38), n(39), n(46), n(47), n(48), n(52), n(53), n(56), n(59)
	}, function(e, t, n) {
		var i, r;
		!
			function(t, n) {
				...
				ce.fn = ce.prototype = {
					...
					var e, t, n, i, r, o, a = arguments[0] || {},
						...
						c = arguments.length,
						u = !1;
					for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || ce.isFunction(a) || (a = {}), s === c && (a = this, s--); c > s; s++) if (null != (r = arguments[s])) for (i in r) e = a[i], n = r[i], a !== n && (u && n && (ce.isPlainObject(n) || (t = ce.isArray(n))) ? (t ? (t = !1, o = e && ce.isArray(e) ? e : []) : o = e && ce.isPlainObject(e) ? e : {}, a[i] = ce.extend(u, o, n)) : void 0 !== n && (a[i] = n));
					return a
				}, ce.extend({
					...
					map: function(e, t, n) {
						var i, r = 0,
							...
							s = a(e),
							c = [];
						if (s) for (; o > r; r++) i = t(e[r], r, n), null != i && c.push(i);
						else for (r in e) i = t(e[r], r, n), null != i && c.push(i);
						return ee.apply([], c)
					},
					guid: 1,
					proxy: function(e, t) {
					...
					dispatch: function(e) {
						...
						if (s[0] = e, e.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, e) !== !1) {
							for (a = ce.event.handlers.call(this, e, c), t = 0;
								 (r = a[t++]) && !e.isPropagationStopped();) for (e.currentTarget = r.elem, o = 0;
				...
				Ze.optgroup = Ze.option, Ze.tbody = Ze.tfoot = Ze.colgroup = Ze.caption = Ze.thead, Ze.th = Ze.td, ce.extend({
					...
					buildFragment: function(e, t, n, i) {
						for (var r, o, a, s, c, u, l, d = e.length, f = b(t), p = [], h = 0; d > h; h++) if (o = e[h], o || 0 === o) if ("object" === ce.type(o)) ce.merge(p, o.nodeType ? [o] : o);
						else if (Ge.test(o)) {
					...
					cleanData: function(e, t) {
						for (var n, i, r, o, a = 0, s = ce.expando, c = ce.cache, u = ae.deleteExpando, l = ce.event.special; null != (n = e[a]); a++) if ((t || ce.acceptData(n)) && (r = n[s], o = r && c[r])) {
				...
				ce.fn.extend({
					...
					removeAttr: function(e, t) {
						var n, i, r = 0,
							o = t && t.match(Te);
						if (o && 1 === e.nodeType) for (; n = o[r++];) i = ce.propFix[n] || n, ce.expr.match.bool.test(n) ? Lt && At || !It.test(n) ? e[i] = !1 : e[ce.camelCase("default-" + n)] = e[i] = !1 : ce.attr(e, n, ""), e.removeAttribute(At ? n : i)
					},
					attrHooks: {
						type: {
							set: function(e, t) {
				...
				ce.fn.extend({
					...
					toggleClass: function(e, t) {
						...
						return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(ce.isFunction(e) ?
							...
							if ("string" === n) for (var t, i = 0, r = ce(this), o = e.match(Te) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
		...
		(function(r) {
			(function() {
				...
				var v = u(),
					...
					x = 0,
					C = c;
				if (C.v1 = s, C.v4 = c, C.parse = o, C.unparse = a, C.BufferClass = p, l.define && n(45)) i = function() {
					return C
				}.call(t, n, t, e), !(void 0 !== i && (e.exports = i));
		...
		e.exports = function(e) {
			...
			if (n) for (var i, r = -1, o = n.length - 1; o > r;) {
				...
				var a = i.right;
				if (a) for (var s, c = -1, u = a.length - 1; u > c;) s = a[c += 1], t += " <li", s.is_buy && (t += ' class="star-goods"'), t += '> <a class="link" href="' + s.url + '"><img class="thumb" src="//c1.mifile.cn/f/i/2014/cn/placeholder-40.png" data-src="' + s.img + '?width=40&height=40" srcset="' + s.img + '?width=80&height=80 2x" width="40" height="40" alt="" /><span class="text">' + s.title + "</span></a> ", s.is_buy && (t += '<a class="btn btn-line-primary btn-small btn-buy" href="' + s.buy_url + '">选购</a>'), t += " </li> ";
				t += " </ul> </div> </li> "
			}
			return t += " </ul></div>"
		}
		...
		!
			function(e) {
				...
				var a = e("#J_searchForm"),
					...
					p = 0,
					h = 0;
				if(1==2 && c.data("search-config") != "" && c.data("search-config") != 'undefined'){
		...
		n(54), MI.addShopCart = function(e, t, n, i) {
